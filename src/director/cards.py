...
KIND_PROMO = "promo"  # "скоро на канале" - hypes an upcoming programme from the schedule

ALL_KINDS = (
    KIND_EPG_DAY, KIND_EPG_NEXT, KIND_WEATHER, KIND_CLOCK, KIND_CURRENCY, KIND_HOROSCOPE, KIND_PROMO,
)
